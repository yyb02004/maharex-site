    ...
    <>
      <section className="bg-graphite py-24 text-white">
        <div className="container">
          ...
          <h1 className="mt-5 text-4xl font-black leading-tight md:text-6xl">적격성평가 / Validation</h1>
      ...
      <section className="py-20">
        <div className="container">
          <div className="mb-10 border-2 border-cobalt/25 bg-white p-7 shadow-sm md:p-9">
            ...
            <div className="mt-4 max-w-4xl space-y-3 text-base font-semibold leading-8 text-graphite">
              <p>공정, 시설 또는 시스템이 사용자가 의도한 대로 적절히 기능하고 있음을 체계적으로 조사·검토하여 문서화하는 활동입니다.</p>
              <p>Validation이 수행되었다는 것은 품질 규격에 적합한 제품 또는 설비가 일관되게 제공될 수 있음을 증명하는 의미를 갖습니다.</p>
            </div>
          </div>
